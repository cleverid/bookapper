 ...
 * @property ArticleLang[] $article_lang
 * @property Image $image
 */
class Article extends CModelBase
{
    public $langId;
     ...
     * @return string
     */
    public function getTitleWithPosition(){
        if($this->code == 'about') {
            return $this->getLangPart()->title;
        } else {
            return $this->position.'. '.$this->getLangPart()->title;
        }
    }
